...
static const char *fonts[]          = { "Inconsolata for Powerline:size=26:antialias=true", "Inconsolata for Powerline:size=26:antialias=true" };
static char dmenufont[]       = "Inconsolata for Powerline:size=20";
