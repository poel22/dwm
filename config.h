...
static const char *fonts[]          = { "Inconsolata for Powerline:size=16:antialias=true", "Inconsolata for Powerline:size=16:antialias=true" };
static char dmenufont[]       = "Inconsolata for Powerline:size=16";
